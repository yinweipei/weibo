...
<head>
    ...
    <link rel="stylesheet" href="/weibo/Public/Home/Theme/<?php echo ($style); ?>/Css/index.css" />
            ...
            <div class="weibo">
                ...
                <div class="face">
                    <a href="<?php echo U('/' . $v['uid']);?>">
                        ...
                        <?php else: ?>
                            /weibo/Public/Home/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
                    </a>
                </div>
                <div class="wb_cons">
                    <dl>
                ...
                <!--=====回复框=====-->
                    <div class='comment_load hidden'>
                        <img src="/weibo/Public/Home/Images/loading.gif">评论加载中，请稍候...
                    </div>
