...
<head>
	...
	<link rel="stylesheet" href="/weibo/Public/Home/Theme/default/Css/nav.css" />
	<link rel="stylesheet" href="/weibo/Public/Home/Theme/default/Css/edit.css" />
    ...
    <script type='text/javascript' src='/weibo/Public/Home/Js/city.js'></script>
	<script type='text/javascript' src='/weibo/Public/Home/Js/edit.js'></script>
    	...
    	<div id='right'>
    		...
    		<div class='form hidden'>
    			<form action="<?php echo U('editFace');?>" method='post'>
	    			<div class='edit-face'>
	    				<img src="
                        <?php if($user["face180"]): ?>/weibo/Uploads/Face/<?php echo ($user["face180"]); ?>
                        <?php else: ?>
                            /weibo/Public/Home/Images/noface.gif<?php endif; ?>" width='180' height='180' id='face-img'/>
	    				<p>
