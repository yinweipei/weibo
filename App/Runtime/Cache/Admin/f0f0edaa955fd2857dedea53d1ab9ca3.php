...
<head>
    ...
    <link rel="stylesheet" href="/weibo/Public/Admin/Css/login.css" />
    <link rel="stylesheet" href="/weibo/Public/Admin/Js/JqueryUI/jquery-ui-1.9.2.min.css" />
    <script type="text/javascript" src='/weibo/Public/Admin/Js/jquery-1.8.2.min.js'></script>
    <script type="text/javascript" src='/weibo/Public/Admin/Js/JqueryUI/jquery-ui-1.9.2.min.js'></script>
    <script type="text/javascript" src='/weibo/Public/Admin/Js/login.js'></script>
</head>
<body>
    <div id='top'>
        <!-- <a href='http://www.houdunwang.com' target='_blank'>
            <img src='/weibo/Public/Admin/Images/blogo.png' width='270' height='52'/>
        </a> -->
