...
<head>
	...
	<title>微博用户列表</title>
	<link rel="stylesheet" href="/weibo/Public/Admin/Css/common.css" />
	<script type="text/javascript" src='/weibo/Public/Admin/Js/jquery-1.8.2.min.js'></script>
	<script type="text/javascript" src='/weibo/Public/Admin/Js/common.js'></script>
</head>
<body>
	<div class='status'>
		<span>微博用户检索</span>
	...
	<div style='width:600px;text-align:center;margin : 20px auto;'>
		<form action="/weibo/Admin/User/sechUser.html?type=0&amp;sech=" method='get'>
			检索方式：
			<select name="type">
		...
		<?php else: ?>
			...
			<?php if(is_array($user)): foreach($user as $key=>$v): ?><tr>
					...
					<td width='80' align='center'>
						<img src="<?php if($v["face"]): ?>/weibo/Uploads/Face/<?php echo ($v["face"]); else: ?>/weibo/Public/Admin/Images/noface.gif<?php endif; ?>" width='50' height='50'/>
					</td>
					<td align='center'>
						<ul>
